...
class ApplicantSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $people = [
            ...
            ['Jose', 'Bautista', 'Male', 33, 'Married', 'Qualified', false],
            ...
            ['Jenny', 'Rosales', 'Female', 26, 'Married', 'Qualified', true],
            ['Allan', 'Dizon', 'Male', 35, 'Married', 'Paid', true],
            ['Cristina', 'Flores', 'Female', 20, 'Single', 'Qualified', true],
            ...
            ['Carlo', 'Ramos', 'Male', 30, 'Married', 'Qualified', true],

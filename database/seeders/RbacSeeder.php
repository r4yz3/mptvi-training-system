...
class RbacSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $accounts = [
            ['admin',       'Eleonil Epracse', 'admin@mptvi.test'],
            ['manager',     'Jane Doe',        'secretary@mptvi.test'],
            ['registrar',   'Juan dela Cruz',  'registrar@mptvi.test'],
            ['cashier',     'Jane Smith',      'cashier@mptvi.test'],
            ['coordinator', 'Jhon Doe',        'coordinator@mptvi.test'],
        ];
